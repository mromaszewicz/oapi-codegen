...
//
// It is deliberately false for inline unions: those are generated by emitting
// the union struct at this schema position, with its own MarshalJSON. The
// template's existing $hasUnionElements branch handles encoding by writing
// .union directly, so no delegation is needed.
